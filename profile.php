					...
					<div style="font-size: 20px;color: black;">
						...
						<?php if($user_data['userid'] == $_SESSION['mybook_userid']): ?>
							<a href="<?=ROOT?>messages">
								<input id="post_button" type="button" value="Messages" style="margin-right:10px;background-color: #1b9186;width:auto;border: 1px solid #8B0000;
    																											height: 32px;
    																											font-size: 12px;
    																											border-radius: 20px;
    																											padding: 0 10px;
